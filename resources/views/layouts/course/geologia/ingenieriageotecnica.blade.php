...
{{-- Title curso start--}}
@php
    $textTitulo = "Ingeniería Geotécnica Aplicada a Minería";
@endphp
<script>
        ...
        <div class="container-fluid col-11 content_banner__home m-auto ml-lg-0 ">
            <div class="row">
                <div class="col-12 col-lg-4 cont-img-poople d-none d-lg-block" data-aos="fade-right">
                    <img src="{{asset('images/icons-generals/geologia/banner-people-ingenieria-geotecnica.png')}}" alt="Personal educativo">
                </div>
                ...
                <div class="col-12 col-md-7 col-lg-4 col-xl-5 text-white text-info_banner">
                    ...
                    <h3 data-aos="fade-up" id="title-curso" class="d-none d-md-block text-uppercas">INGENIERÍA GEOTÉCNICA</h3>
                    <div data-aos="fade-up" class="cont-white d-none d-md-block text-uppercase"><h3 class="text-primary" style="text-shadow: none;">APLICADA A MINERÍA</h3></div>
                    <h3 data-aos="fade-up" id="" class="d-block d-md-none text-uppercase">
                        Programa de INGENIERÍA GEOTÉCNICA APLICADA A MINERÍA
                    </h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12 shadow-sm bg-white d-flex pb-3 pt-4 px-auto px-sm-5">
                                <div class=" align-self-center">
                                    ...
                                    <p class="">
                                        Al finalizar el programa el participante estará en la capacidad de diseñar obras geotécnicas 
                                        relacionadas con la minería superficial, los conocimientos se dirigen a fundamentalmente al 
                                        planeamiento y cálculo de excavaciones tanto en minería superficial como subterránea. Asimismo, 
                                        podrá desarrollar el Diseño y Modelización en Obras Geotécnicas aplicados a minería, haciendo uso 
                                        correcto de los softwares, interpretando resultados de manera óptima para la toma de decisiones 
                                        rápidas y eficientes en las Operaciones Mineras.
                                    </p>
                                    ...
                                    <p class="">
                                        ...
                                        mecánica de rocas y suelos, geofísica, geociencias, consultores e investigadores, que deseen 
                                        actualizarse en el sector minero.<br>
                                        Gerentes de operaciones, jefes y ejecutivos de compañías mineras que desarrollan sus actividades 
                                        profesionales en áreas relacionadas con la geología, geotecnia, ingeniería civil, geomecánica y minería. 
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-12 shadow-sm bg-white d-flex pb-3 pt-4 px-auto px-sm-5">
                                <div class="align-self-center">
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo I</span> - Mecánica de Suelos Aplicada en Minería
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo II</span> - Ensayos en Laboratorio e Instrumentación Geotécnica
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo III</span> - Estudio del agua y su aplicación en geotecnia minera
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo IV</span> - Ingeniería Geotécnica Aplicada al Diseño de Excavaciones en Minería Superficial
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo V</span> - Ingeniería Geotécnica Aplicada al Diseño de Excavaciones en Minería Subterránea
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo VI</span> - Modelamiento y Simulación Aplicada a la Ingeniería Geotécnica Minera
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Software: </span>DIPS, SLIDE, RS2 (PHASE2), ROCPLANE, SWEDGE, ROCFALL, UNWEDGE, ROCDATA, CYPE, SLIDE, UNWEDGE, PLAXIS, GEOSLOPE
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <?php
                    $expositores = [
                        [   
                            ...
                            'expositorName' => 'MG. Ricardo Cato Quintana',
                            'expositorDescription' => 'Empresario, Profesor de la Maestría de Supply Chain Management del Graduate School 
                            of Business de ESAN. Con más de 20 años de experiencia en el sector minería, petróleo y servicios, en las 
                            áreas de Supply Chain Management, Operaciones y Logística, Planeamiento Estratégico y Tecnologías de Información. 
                            Ingeniero Electrónico de la Universidad Nacional de Ingeniería; Magister en “Supply Chain',                            
                        ],
                        [   
                            'expositorImg' => 'images/expositores/ricardo-fernandez.png',
                            'expositorName' => 'Ing. Ricardo Fernández',
                            'expositorDescription' => 'Ingeniero de la Especialidad de Ingeniería de Minas por la Universidad Nacional de Ingenieria - UNI. 
                            Con más de 15 años de experiencia en Gestión y Dirección Operativa Administrativa, Diseño y Ejecución de Perforación y 
                            Voladura para Minería a tajo abierto, subterránea y obras civiles. Gerente de servicios de Optimización de uso de explosivos 
                            mediante métodos numéricos, tanto en superficie como en  ….',                            
                        ],
                        [   
                            'expositorImg' => 'images/expositores/patricio-oportus.png',
                            'expositorName' => 'Mg. Patricio Oportus',
                            'expositorDescription' => 'Magister en Marketing y Gestión Comercial por la Escuela Superior de Estudios de Marketing en 
                            Madrid - España. Ingeniero Civil de Minas por la Universidad de Santiago de Chile, con amplia experiencia en la ejecución 
                            de proyectos mineros. Consultor Senior de Organismos Internacionales, empresas privadas y del sector público. Investigador 
                            y Conferencista en: Bolivia, Chile, España, Estados Unidos, México, Perú y Suecia.',                            
                        ],
                        [   
                            'expositorImg' => 'images/expositores/luis-ayma.png',
                            'expositorName' => 'Mg. Luis A. Ayma',
