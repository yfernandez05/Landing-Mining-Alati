...
{{-- Title curso start--}}
@php
    $textTitulo = "Hidrogeología Minera Avanzada - ITR";
@endphp
<script>
        ...
        <div class="container-fluid col-11 content_banner__home m-auto ml-lg-0 ">
            <div class="row">
                <div class="col-12 col-lg-4 cont-img-poople d-none d-lg-block" data-aos="fade-right">
                    <img src="{{asset('images/icons-generals/geologia/banner-people-hidrogeologia-minera.png')}}" alt="Personal educativo">
                </div>
                ...
                <div class="col-12 col-md-7 col-lg-4 col-xl-5 text-white text-info_banner">
                    ...
                    <h3 data-aos="fade-up" id="title-curso" class="d-none d-md-block text-uppercas">HIDROGEOLOGÍA</h3>
                    <div data-aos="fade-up" class="cont-white d-none d-md-block text-uppercase"><h3 class="text-primary" style="text-shadow: none;">MINERA AVANZADA</h3></div>
                    <h3 data-aos="fade-up" id="" class="d-block d-md-none text-uppercase">
                        Programa de HIDROGEOLOGÍA MINERA AVANZADA
                    </h3>             
                </div>
                        ...
                        <div class="row">
                            <div class="col-12 shadow-sm bg-white d-flex pb-3 pt-4 px-auto px-sm-5">
                                <div class=" align-self-center">
                                    ...
                                    <p class="">
                                        Al finalizar el diplomado, el participante aplicará conocimientos especializados 
                                        en hidrogeología a las particularidades de las operaciones mineras. Asimismo, podrá 
                                        ejecutar estrategias de vanguardia para optimizar el drenaje de minas a cielo abierto 
                                        y subterráneas. Estará capacitado para prevenir y aplicar soluciones a los principales 
                                        problemas ambientales y optimizar la caracterización hidrogeológica para el aprovisionamiento 
                                        de agua de las operaciones mineras
                                    </p>

                                    <h4 class="text-primary">Dirigido a:</h4>
                                    <p class="">
                                        Ingenieros geólogos, ingenieros civiles, ingenieros de minas, ingenieros ambientales, 
                                        licenciados en geología, licenciados en ciencias ambientales. En general, profesionales 
                                        interesados en la gestión del agua en las operaciones mineras tanto en su cantidad como 
                                        en su calidad.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-12 shadow-sm bg-white d-flex pb-3 pt-4 px-auto px-sm-5">
                                <div class="align-self-center">
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo I</span> - Hidrogeología y Métodos de Explotación Minera
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo II</span> - Hidrogeoquímica e Isotopías de Aguas
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo III</span> - Calidad de Aguas Subterráneas y Proyectos de Remediación
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo IV</span> - Balance Hídrico de un Acuífero Aplicado a la Minería
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Software: </span>AQUACHEM, PHREEQC, PHAST FREEWAT PROYECT, QGIS, MOD FLOW Model Muse Mod Flow, AQT, AqQA, Aquachem, Aquifer, Hydro Geo Analyst
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-duration="600">
            <div class="col slider-expositores text-center">
                <?php
                    $expositores = [
                        [   
                            'expositorImg' => 'images/expositores/roberto-poncela.png',
                            'expositorName' => 'Dr. Roberto Poncela',
                            'expositorDescription' => 'Ingeniero Civil y Licenciado en Ciencias de la Ingeniería de la Universidad Federico Santa María 
                            - Chile, Especialista Estructural Geotécnico con una muy amplia experiencia en el rubro minero, se ha desempeñado como 
                            Ingeniero Geotécnico de la Empresa Montgomery Watson’s Global MWH Américas Inc. Chile Ltda., Ingeniero revisor Estructural 
                            y Geotécnico de la Unidad de Ingeniería del Serviu de Valparaíso, Ingeniero de Proyectos de Vector Chile Ltda, en el 
                            diseño de sus proyectos de Pilas de Lixiviación. Actualmente consultor en Perú y Chile.',                            
                        ],
                        [   
                            'expositorImg' => 'images/expositores/julio-verdejo.png',
                            'expositorName' => 'Dr. Julio Verdejo',
                            'expositorDescription' => 'Doctor en DIMARMA UPM - Investigación, Modelización y Análisis del Riesgo en Medio Ambiente por la 
                            Universidad Politécnica de Madrid - España. Especialista en Modelización numérica, Hidrogeología aplicada a la Minería, el 
                            Medio Ambiente y la Obra Civil. Responsable del departamento de Hidrogeología e Investigación, Modelos numéricos en el 
                            ámbito del agua subterránea, en importantes empresas tales como Geoconsult Ingenieros Consultores, FRASA. Actualmente 
                            consultor en España, Perú, Portugal, Chile, Brasil y Zambia.',                            
                        ],
                    ];
                ?>
