...
{{-- Title curso start--}}
@php
    $textTitulo = "Plantas de Procesamiento de Minerales";
@endphp
<script>
        ...
        <div class="container-fluid col-11 content_banner__home m-auto ml-lg-0 ">
            <div class="row">
                <div class="col-12 col-lg-4 cont-img-poople d-none d-lg-block" data-aos="fade-right">
                    <img src="{{asset('images/icons-generals/metalurgia/banner-people-plantas-procesamiento.png')}}" alt="Personal educativo">
                </div>
                ...
                <div class="col-12 col-md-7 col-lg-4 col-xl-5 text-white text-info_banner">
                    ...
                    <h3 data-aos="fade-up" id="title-curso" class="d-none d-md-block text-uppercase">PLANTAS DE PROCESAMIENTO</h3>
                    <div data-aos="fade-up" class="cont-white d-none d-md-block text-uppercase"><h3 class="text-primary" style="text-shadow: none;">DE MINERALES</h3></div>
                    <h3 data-aos="fade-up" id="" class="d-block d-md-none text-uppercase">
                        Programa de PLANTAS DE PROCESAMIENTO DE MINERALES
                    </h3>                
                </div>
                        ...
                        <div class="row">
                            <div class="col-12 shadow-sm bg-white d-flex pb-3 pt-4 px-auto px-sm-5">
                                <div class=" align-self-center">
                                    ...
                                    <p class="">
                                        Al finalizar el programa el participante podrá tomar optimas decisiones, 
                                        para la adquisición o modificación de procesos, sistemas y equipos empleados 
                                        en plantas de procesamiento de minerales, disminuyendo los factores de riesgo 
                                        de inversión a su vez de optimizando los resultados operativos.
                                    </p>

                                    <h4 class="text-primary">Dirigido a:</h4>
                                    <p class="">
                                        Dirigido a ingenieros metalurgistas, ingenieros de minas, geólogos, ingenieros 
                                        químicos, ingenieros industriales, ingenieros ambientalistas, consultores, 
                                        profesionales de entidades gubernamentales, empresas mineras, empresas contratistas, 
                                        docentes e investigadores, estudiantes de posgrado y público en general, que tengan 
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-12 shadow-sm bg-white d-flex pb-3 pt-4 px-auto px-sm-5">
                                <div class="align-self-center">
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo I</span> - Optimización y Técnicas Modernas en la Reducción de Tamaños y Clasificación
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo II</span> - Flotación de Minerales, Separación Sólido-Líquido
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo III</span> - Pruebas Metalúrgicas y Análisis de Minerales
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo IV</span> - Balances de Agua en la Minería, Tratamiento de Relaves y Aguas Ácidas de Mina
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo V</span> - Modelamiento y Simulación de Procesos Metalúrgicos
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Módulo VI</span> - Diseño de Plantas Metalúrgicas Aplicados a Plantas de Procesamiento de Minerales
                                    </p>
                                    <p class="">
                                        <span class="text-primary font-primary">Software: </span>Moly-Cop Tools MODSIM_64, Statgraphics centurion, Moly-Cop Tools
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <?php
                    $expositores = [
                        [   
                            ...
                            'expositorDescription' => 'Doctor en Ciencias de la Ingenieria mención Ingenieria Metalúrgica por la Universidad de Concepción, 
                            Ingeniero Civil Metalurgista por la Universidad Técnica del Estado  Chile, Investigador en Hidrometalurgia, 
                            Lixiviación, Extracción por Solvente, Tratamiento de Efluentes. Catedrático de la Universidad Santiago de Chile  USACH. 
                            Actualmente Consultor especializado en Metalurgia del Oro, Plata, Cobre y polimetálicos. Investigador y conferencista en 
                            Chile, Argentina y Perú.',                            
                        ],
                        [   
                            'expositorImg' => 'images/expositores/levi-guzman-rivera.png',
                            'expositorName' => 'Ing. Levi Guzmán',
                            'expositorDescription' => 'Ingeniero Metalúrgico por la Universidad Nacional de San Agustín de Arequipa - Perú, especialista 
                            en Procesamiento de Minerales - Innovación Tecnológica en minería por la Universidad Antofagasta de Chile, Habilidades 
                            Directivas en Tecnológico de Monterrey de México, Geometalurgia por la Pontificia Universidad Católica del Perú. Especialista 
                            en análisis y estudios de optimización de circuitos de molienda/clasificación, ha realizado trabajos de investigación referentes 
                            a optimización de esquemas de reactivos de flotación en la Compañía Minera Antamina, Sociedad Minera Cerro Verde, MMG Las 
                            Bambas entre otras. Catedrático de Geometalurgia en la Pontificia Universidad Católica del Perú. Actualmente labora como 
                            Líder de aplicaciones en Moly Cop Adesur S.A.',                            
                        ],
                        [   
                            'expositorImg' => 'images/expositores/luis-vizcardo.png',
                            'expositorName' => 'Mg. Luis Vizcardo',
                            'expositorDescription' => 'Magister en Mecánica de Fluidos Computacionales por la Universidad de Cuyo - Argentina, Magister 
                            en Metalurgia por la Universidad Nacional de San Agustín - Arequipa - Perú, Especialista en “Simulación de Plantas usando 
                            Software MODSIM”, Catedrático de Metalurgia, de universidades privadas en nuestro país, Consultor de Hochschild Mining, 
                            Minera Shougang y otras mineras reconocidas a nivel Nacional e Internacional.',                            
                        ],
                    ];
                ?>
                ...
                <div class="row justify-content-center slider-cursosdestacados">
                    ...
                    $cursosDestacados = [
                            [
                                ...
                                'destacadosDescription' => 'Metalurgia Extractiva de Cobre, Oro Y Plata',
                            ],
                            [
                                'destacadosDescription' => 'Geometalurgia',
                            ],
                            [
                                'destacadosDescription' => 'Procesos Acuosos para el Tratamiento de Minerales de Cobre',
                            ],
                        ];
                    ?>
