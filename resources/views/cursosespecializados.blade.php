        ...
        <div class="container-fluid col-11 content_banner__home m-auto ml-lg-0 ">
            <div class="row">
                ...
                <div class="col-12 col-md-7 col-lg-4 col-xl-5 text-white text-info_banner">
                    <h3 data-aos="fade-up" id="title-curso">CURSOS ESPECIALIZADOS</h3>
                    <div data-aos="fade-up" class="cont-white d-none d-lg-block"><h3 class="text-primary" style="text-shadow: none;">ASINCRÓNICOS Y ONLINE</h3></div>
                    <h5 class="font-secondary d-none d-lg-block" data-aos="zoom-out-right" data-aos-duration="800">
                        Certifícate como especialista en el  área de tu interés
                    </h5>                
                </div>
                ...
                <div class="col-sm justify-content-center cont-form" data-aos="fade-left"  data-aos-duration="800">
                    <div class="col-12 col-md-12 col-lg-12 align-self-center p-0">
                        <?php
                            $cursoEstado = false;
                        ?>
                        @include('layouts.partials.utils.formulario', compact('cursoEstado'))                        
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <?php
                        $porqueelerginosItems = [
                            [
                                ...
                                'porqueelegirnosTitle' => 'METODOLOGÍA<br>EDUCATIVA',
                                'porqueelegirnosDescripcion' => 'Nuestro modelo educativo te permite aprender a través de la practica',
                            ],
                            [
                                'porqueelegirnosIcon' => 'images/icons-generals/icon-flexibilidad.png',
                                'porqueelegirnosTitle' => 'FLEXIBILIDAD<br>HORARIA',
                            ...
                            [
                                ...
                                'porqueelegirnosTitle' => 'PLATAFORMA<br>VIRTUAL',
                                'porqueelegirnosDescripcion' => 'Accede a nuestra plataforma desde cualquier dispositivo con conexion a internet',                                
                            ],
                            [
                                'porqueelegirnosIcon' => 'images/icons-generals/icon-aforo.png',
                                'porqueelegirnosTitle' => 'FORO<BR>ALUMNO',
                                'porqueelegirnosDescripcion' => 'Intereactua con los docentes y compañeros, a través de cada sesión en vivo',                                
                            ],
                        ];
                    ?>
    ...
    <section id="especialidades" class="section_profesionales bg-white mb-3 py-4 position-relative">
        ...
        <div class="container bg-info cont-info py-5 shadow position-relative" data-aos="fade-up">        
            <div class="co-12 p-4 mt-5">
                <h2 class="text-primary text-center text-uppercase p-2 bg-white m-auto">
                    ¿Qué es un Curso Especializado en Minería?
                </h2>            
            </div>
            <div class="col-12 col-lg-8 m-auto mb-5">
                <p class="mt-2 text-center text-white ">
                    Alineados a las últimas tendencias del mercado presentamos un programa de certificación progresiva 
                    que te da la flexibilidad de elegir 5 cursos del área de tu interés + Soft Skills para obtener el 
                    Diploma de Especialización en Minería.Conoe todas las áreas que tenemos para ti
                </p>
            </div>
        </div>
        ...
        <div class="container-fluid position-relative" data-aos="fade-up" data-aos-duration="1000" >
            <div class="row justify-content-center">
                ...
                <a class="waves bg-gray col-6 col-md-4 col-lg py-3 py-lg-5 collapse-item collapsed col-collapse d-flex align-items-center flex-lg-wrap text-decoration-none" href="{{route('cursosonline')}}">
                    <div class="col-6 col-lg-7 m-auto">
                        <img src="{{asset('images/icons-generals/icon-cursosonline.png')}}" alt="gestion" class="img-fluid">
                    </div>
                    <div class="col-12 text-center text-secondary">
                        <p class="m-0">Cursos Online</p>
                    </div>
                </a>           
            </div>
        </div>
